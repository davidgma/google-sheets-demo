...
/* harmony import */ var _longer_longer_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./longer/longer.component */ "./src/app/longer/longer.component.ts");
...
/* harmony import */ var _longer_longer_routing_module__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./longer/longer-routing.module */ "./src/app/longer/longer-routing.module.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            imports: [
                ...
                _longer_longer_routing_module__WEBPACK_IMPORTED_MODULE_13__["LongerRoutingModule"],
            ...
            declarations: [
                ...
                _longer_longer_component__WEBPACK_IMPORTED_MODULE_9__["LongerComponent"],
...
/***/ "./src/app/longer/longer-routing.module.ts":
/*!*************************************************!*\
  !*** ./src/app/longer/longer-routing.module.ts ***!
  \*************************************************/
/*! exports provided: LongerRoutingModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LongerRoutingModule", function() { return LongerRoutingModule; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var _longer_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./longer.component */ "./src/app/longer/longer.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    { path: 'longer', component: _longer_component__WEBPACK_IMPORTED_MODULE_2__["LongerComponent"] }
];
var LongerRoutingModule = /** @class */ (function () {
    function LongerRoutingModule() {
    }
    LongerRoutingModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            imports: [
                _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forChild(routes)
            ],
...
/***/ "./src/app/longer/longer.component.css":
/*!*********************************************!*\
  !*** ./src/app/longer/longer.component.css ***!
  \*********************************************/
/*! no static exports found */
...
/***/ "./src/app/longer/longer.component.html":
/*!**********************************************!*\
  !*** ./src/app/longer/longer.component.html ***!
  \**********************************************/
/*! no static exports found */
...
/***/ "./src/app/longer/longer.component.ts":
/*!********************************************!*\
  !*** ./src/app/longer/longer.component.ts ***!
  \********************************************/
/*! exports provided: LongerComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LongerComponent", function() { return LongerComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _google_auth_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../google-auth.service */ "./src/app/google-auth.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
...
var LongerComponent = /** @class */ (function () {
    function LongerComponent(cd, gauth) {
        this.cd = cd;
        this.gauth = gauth;
        this.output = new Array();
        this.output.push("loading..");
    }
    LongerComponent.prototype.ngOnInit = function () {
        var _this = this;
        ...
        this.gauth.signIn.subscribe(function () {
            _this.run();
        });
    }; // End of ngOnInit
    LongerComponent.prototype.run = function () {
        return __awaiter(this, void 0, void 0, function () {
            var request;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.gauth.loadClient()];
                    case 1:
                        _a.sent();
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.gauth.loadDriveAPI()];
                    case 3:
                        _a.sent();
    ...
    LongerComponent.prototype.setKey = function (o, name, value) {
    ...
    LongerComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-longer',
            template: __webpack_require__(/*! ./longer.component.html */ "./src/app/longer/longer.component.html"),
            styles: [__webpack_require__(/*! ./longer.component.css */ "./src/app/longer/longer.component.css")]
        }),
        __metadata("design:paramtypes", [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ChangeDetectorRef"],
            _google_auth_service__WEBPACK_IMPORTED_MODULE_1__["GoogleAuthService"]])
    ], LongerComponent);
    return LongerComponent;
